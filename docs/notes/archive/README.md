...
If you'd like to develop `omicsio` you'll need the [nix package manager](https://nix.dev).
...
Available recipes:
    ...
    [conda]
    conda-build package="omicsio"          # Package commands (conda)
    conda-check package="omicsio"          # Run all checks in conda environment (lint, type, test)
    conda-env package="omicsio"            # Create and sync conda environment with pixi
    conda-lint package="omicsio"           # Run linting in conda environment with pixi
    conda-lint-fix package="omicsio"       # Run linting and fix errors in conda environment with pixi
    conda-lock package="omicsio"           # Update conda environment
    conda-test package="omicsio"           # Run tests in conda environment with pixi
    conda-type package="omicsio"           # Run type checking in conda environment with pixi
    pixi-lock package="omicsio"            # Update pixi lockfile
    ...
    [python]
    check package="omicsio"                # Run all checks for a package (lint, type, test)
    lint package="omicsio"                 # Run linting for a package
    lint-all                                           # Run linting for all packages
    lint-fix package="omicsio"             # Run linting and fix errors for a package
    test package="omicsio"                 # Run tests for a package
    test-all                                           # Run tests for all packages
    type package="omicsio"                 # Run type checking for a package
    uv-build package="omicsio"             # Build a package with uv
    uv-lock package="omicsio"              # Update lockfile for a package
    uv-sync package="omicsio"              # Sync a package environment with uv
    ...
    test-package-release package-name="omicsio" branch="main" # Test package release
