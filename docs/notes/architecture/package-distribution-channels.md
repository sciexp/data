...
| Channel | Supported | Lock file | Runtime dependencies |
|---------|-----------|-----------|---------------------|
| uv/PyPI | Yes | `packages/omicsio/uv.lock` | (none) |
| pixi/conda-forge | Yes | `packages/omicsio/pixi.lock` | python |
...
All recipes accept a package parameter defaulting to `omicsio`.
